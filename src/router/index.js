  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/alltags',
          component: r => require.ensure([], () => r(require('@/views/Tags')), 'tags')
        },
        {
          path: '/searchpage',
          name: 'searchpage',
        ...
        {
          path: '/userinfos',
          component: r => require.ensure([], () => r(require('@/views/UserInfos')), 'userinfos')
        },{
          path: '/user',
          name: 'user',
        ...
        },
        {
          path: '/readblog',
          name: 'readblog',
          component: r => require.ensure([], () => r(require('@/views/ReadBlog')), 'readblog')
        },
        {
          path: '/view/:id',
